...
public enum PermisionList {
    ...
    countrySearch("/api/v1/country/search"),
    otSearch("/api/v1/ot/search"),
    contractSearch("/api/v1/contract/search"),
    componentSearch("/api/v1/component/search"),
    tarifSearch("/api/v1/tariff/search"),
    priceSearch("/api/v1/price/search"),
    readingSearch("/api/v1/reading/search"),
    countrieSearch("/api/v1/country/search"),
    meterSearch("/api/v1/meter/search"),
